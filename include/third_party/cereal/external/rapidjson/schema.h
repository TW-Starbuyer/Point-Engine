...
/*!
    ...
    \note This is an immutable class (i.e. its core cannot be modified after construction).
...
public:
    ...
    /*!
        ...
        \param allocator An optional allocator core for allocating memory. Can be null.
    */
